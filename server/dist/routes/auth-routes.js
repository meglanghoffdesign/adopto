...
var login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, password, user, passwordIsValid, secretKey, token, error_1;
        ...
        switch (_b.label) {
            ...
            case 2:
                ...
                if (!user) {
                    ...
                    return [2 /*return*/, res.status(401).json({ message: 'Authentication user failed' })];
                }
            ...
            case 3:
                ...
                if (!passwordIsValid) {
                    ...
                    return [2 /*return*/, res.status(401).json({ message: 'Authentication password failed' })];
                }
                console.log('Password valid, generating JWT token...');
                secretKey = process.env.JWT_SECRET_KEY || 'handsome';
